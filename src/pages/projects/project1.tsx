    ...
    <>
      ...
      <div className="container mx-auto px-8 lg:px-12 max-w-screen-lg py-12 lg:py-16">
        ...
        <p className="text-lg lg:text-xl text-base-content mb-8">
          The SME Growth Recommender is a web-based application I developed during my software development studio subject.
        </p>
        
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-base-content mb-4">Project Overview</h2>
          <p className="text-base-content mb-4">
            This subject is designed to emulate a real software development practice, where student teams work on industry-initiated projects.
             I worked in a group of 8, where I played a leadership role as a team co-lead and interim team lead. Our team collaborated with the
              program lead of SMEs@UTS, a program enabling businesses to reach their potential growth. This project collaborated with a data science teams
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-base-content mb-4">Problem and Opportunity</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-base-content mb-4">Solution Process</h2>
          <ol className="list-decimal list-inside text-base-content">
            <li className="mb-2">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-base-content mb-4">Technologies and Tech Stack</h2>
          <p className="text-base-content mb-4">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-base-content mb-4">Lessons Learned</h2>
          <p className="text-base-content mb-4">
            ...
            I completed sprint planning, sprint retrospectives and attended weekly stakeholder meetings with various clients.
             This experience
            gave me insights into software development and strengthed my leadership and teamwork capabilities.
          </p>
        </section>

        <section className="mb-12">
          <h2 className="text-2xl font-bold text-base-content mb-4">Project Links</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-base-content mb-4">Team Photo</h2>
